...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-pink-100 dark:border-gray-800">
            ...
            {socialLinks.map((link, index) => {
              ...
              return (
                <motion.a
                  ...
                  className="p-3 rounded-xl bg-pink-50 dark:bg-gray-800 border border-pink-100 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:text-pink-500 hover:bg-pink-100 dark:hover:bg-gray-700 transition-all duration-300"
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
