...
export default function Navbar() {
  ...
  return (
    <motion.nav
      className="fixed top-0 left-0 right-0 z-50 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border-b border-pink-100 dark:border-gray-700 shadow-sm"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl bg-pink-50 dark:bg-gray-800 border border-pink-100 dark:border-gray-600 text-gray-500 dark:text-gray-300 hover:bg-pink-100 dark:hover:bg-gray-700 hover:text-pink-500 transition-all duration-300"
              aria-label="切换主题"
            >
              {theme === 'dark' ? (
          ...
          <div className="flex md:hidden items-center space-x-4">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl bg-pink-50 dark:bg-gray-800 border border-pink-100 dark:border-gray-600 text-gray-500 dark:text-gray-300"
              aria-label="切换主题"
            >
              {theme === 'dark' ? (
                <Sun className="h-5 w-5" />
            ...
            <button
              type="button"
              className="p-2 text-gray-500 dark:text-gray-300 hover:text-pink-500 transition-colors"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            className="md:hidden border-t border-pink-100 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl"
